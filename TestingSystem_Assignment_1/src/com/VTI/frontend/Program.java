...
public class Program {
	public static void main(String[] args) {
		...
		dep3.departmentID = 3;
		dep3.departmentName = "Human Resources";

		System.out.println("Thông tin phòng ban số 3:");
		System.out.println("ID:" + dep3.departmentID);
		System.out.println("Name:" + dep3.departmentName);
		...
		System.out.println("DepartmentName:" + ac1.department.departmentName);
		...
		System.out.println("DepartmentName:" + ac2.department.departmentName);
		System.out.println("PositionName:" + ac2.position.name);
		System.out.println("Date:" + ac2.createDate);
		// show group tham gia
		System.out.println("Các group ac2 tham gia: " ac2.groups[0].name + ac2.groups[1].name + ac2.groups[2].name);
		...
		System.out.println("DepartmentName:" + ac3.department.departmentName);
		...
		System.out.println("DepartmentName:" + ac4.department.departmentName);
